...
public class ScheduleModel {
    ...
    public String toString() {
        return "Номер недели: " + weekNumber + "\n"
                + "Группа: " + studentGroup.toString() + "\n"
                + "Подгруппа: " + numSubgroup + "\n"
                + "Аудитория: " + auditory.toString() + "\n"
                + "Тайминг: " + lessonTime + "\n"
                + "Предмет: " + subject + " (" + lessonType + ")\n"
                + "Преподаватель: " + employee.toString();
    }
}
